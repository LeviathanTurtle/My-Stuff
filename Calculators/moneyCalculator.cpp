 ...
 * 
 * [SUMMARY]:
 * This program prompts the user for the number of 1, 5, 10, 20, 50, and 100
 * dollar bills they have. It then calculates and outputs the total sum of
 * money based on what the user input. 
 * 
 * 
 * [USE]:

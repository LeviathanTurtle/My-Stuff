...
class arrayListType 
{
   ...
   public:
      ...
      */
      ...
      /*
         insertFirst function insert an integer in the first spot in the array
         pre-condition: array is defined and initialized with valid variables
         post-condition: the first item in the array will be insertItem
      */
      ...
      */
      ...
      /*
         findMax function locate the largest value in the array and output
         pre-condition: array is defined and initialized with valid variables
         post-condition: largest value in the array will be returned
      */

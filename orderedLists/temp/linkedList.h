...
class linkedListType
{
   ...
   private:
      ...
      void forwardPrint(unorderedLinkedListType<Type>) const;
      void reversePrint(unorderedLinkedListType<Type>) const;
};
...
template <class Type>
void linkedListType<Type>::forwardPrint(unorderedLinkedList<Type> *pass) const
{
...
template <class Type>
void linkedlistType<Type>::reversePrint(unorderedLinkedList<Type> *pass) const
{

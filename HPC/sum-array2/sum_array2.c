...
void master_node_process(int chunksize, int numtasks, int taskid)
{
   ...
   // ADDITION HERE
   MPI_Scatter(&data[chunksize],chunksize,MPI_DOUBLE,&data[chunksize],chunksize,
   ...
   MPI_Gather(&offset,1,MPI_INT,&offset,1,MPI_INT,MASTER,MPI_COMM_WORLD);
   MPI_Gather(&data[chunksize],chunksize,MPI_DOUBLE,&data[chunksize],chunksize,
              MPI_DOUBLE,MASTER,MPI_COMM_WORLD);
...
void cluster_node_process(int chunksize, int taskid)
{
   ...
   MPI_Scatter(&offset,1,MPI_INT,&offset,1,MPI_INT,MASTER,MPI_COMM_WORLD);
   MPI_Scatter(&data[chunksize],chunksize,MPI_DOUBLE,&data[chunksize],chunksize,
               MPI_DOUBLE,MASTER,MPI_COMM_WORLD);

   mysum = findSum(data, chunksize, chunksize, taskid);
   ...
   MPI_Gather(&mysum,1,MPI_DOUBLE,NULL,1,MPI_DOUBLE,MASTER,MPI_COMM_WORLD);
